...
from .cool_scenario import Cool_scenario


class ScenaioTemplateExtension(omni.ext.IExt):
    def on_startup(self, ext_id: str):
        self.scenario_name = "scenario template"
        self.category = "Nolon"
        ...
        ui_kwargs = {
            ...
            "doc_link": None,
            "overview": "This is example scenario template.",
            "sample": Cool_scenario(),
        }
